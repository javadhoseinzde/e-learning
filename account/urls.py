...
from .views import CorseProfile, CreateCourse, UpdateCourse, DeleteCourse, TklifProfile, CreateTklif, UpdateTklif, DeleteTklif, TklifAnswerAdmin, RegistrationForm, Quizlist, TeachersProfileList, TeachersProfileDetail
...
urlpatterns = [
    ...
    path("qiuzlist/", Quizlist.as_view(), name="quizlist"),    


    path("teachers-profile/", TeachersProfileList.as_view(), name="teachersprofile"),
    path('teacher-profile/<slug:slug>/', TeachersProfileDetail.as_view(), name="teachersDetail")
